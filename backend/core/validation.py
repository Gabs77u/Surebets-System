        ...
        def decorated_function(*args, **kwargs):
            try:
                ...
                if detect_sql_injection(json_str):
                    logger.warning(f"Tentativa de SQL injection bloqueada: {request.remote_addr}")
...
def validate_and_sanitize_dict(data: Dict[str, Any], allowed_keys: List[str]) -> Dict[str, Any]:
    """
