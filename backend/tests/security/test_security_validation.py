...
class TestSQLInjectionProtection:
    ...
    def test_detect_sql_injection_basic(self):
        ...
        for malicious_input in malicious_inputs:
            assert detect_sql_injection(malicious_input), f"Failed to detect SQL injection: {malicious_input}"
    ...
    def test_detect_sql_injection_false_positives(self):
        ...
        for legitimate_input in legitimate_inputs:
            assert not detect_sql_injection(legitimate_input), f"False positive for: {legitimate_input}"
...
class TestXSSProtection:
    ...
    def test_detect_xss_basic(self):
        ...
        for malicious_input in malicious_inputs:
            assert detect_xss(malicious_input), f"Failed to detect XSS: {malicious_input}"
...
class TestAdvancedSecurity:
    ...
    def test_edge_cases_sql_injection(self):
        ...
        for case in edge_cases:
            assert detect_sql_injection(case), f"Failed to detect advanced SQL injection: {case}"
    ...
    def test_polyglot_injection_attempts(self):
        ...
        for attack in polyglot_attacks:
            assert detect_sql_injection(attack) or detect_xss(attack), f"Failed to detect polyglot attack: {attack[:50]}..."
